            ...
            <div class="milieu" style="margin-top:30px ;">
                <table class="table" >
                    ...
                    <tr>
                        ...
                        $stmt = $connexion->query ("SELECT * FROM filiere");
                    ...
                    <tr>
                        ...
                        width:100%;border:none;outline:none;padding:8px 0 8px 15px;font-size:15px;cursor:pointer;"
                                href="../pages/updateFiliere.php?CodeF=<?php echo $row['CodeF']; ?>">
                                Modifier</a></td>
                        <td><a class="btn"
                        style="background-color:#4C4D4C; color:white;border-radius:30px;
                        width:100%;border:none;outline:none;padding:8px 0 8px 15px;font-size:15px;cursor:pointer;"
                                href="../traitements/deleteFiliere.php?CodeF=<?php echo $row['CodeF']; ?>"
